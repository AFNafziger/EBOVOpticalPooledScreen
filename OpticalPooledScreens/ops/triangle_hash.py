...
def evaluate_match(df_0, df_1, threshold_triangle=.1, threshold_point=2): #.1, 2
...
def merge_sbs_phenotype(df_0_, df_1_, model, threshold=2):
    ...
    columns_0 = {'tile': 'tile', 'cell': 'cell_0',
              'i': 'i_0', 'j': 'j_0','i_og':'i_og_0','j_og':'j_og_0'}
    columns_1 = {'site': 'site', 'cell': 'cell_1',
              'i': 'i_1', 'j': 'j_1','i_og':'i_og_1','j_og':'j_og_1'}

    cols_final = ['well', 'tile', 'cell_0', 'i_0', 'j_0','i_og_0','j_og_0', 
                  'site', 'cell_1', 'i_1', 'j_1', 'i_og_1','j_og_1','distance'] 
